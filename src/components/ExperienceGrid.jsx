      ...
      <div className="mx-auto max-w-[1200px] px-6 py-24 lg:py-32">
        ...
        <div className="mt-10 grid md:grid-cols-3 gap-6">
          {partners.map((p, i) => (
            ...
            >
              <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition duration-300" style={{ background: 'radial-gradient(400px_200px_at_20%_0%,rgba(56,189,248,0.10),transparent)'}} />
              ...
              {studies.map((s, i) => (
                <div key={i} className="snap-start shrink-0 w-[85%] md:w-[520px]">
                  <div className="relative h-[320px] rounded-2xl border border-white/10 bg-gradient-to-br from-white/5 to-transparent overflow-hidden group">
                    <div className="absolute inset-0 bg-[radial-gradient(600px_300px_at_70%_10%,rgba(201,168,106,0.10),transparent)] opacity-60" />
                    ...
                    <div className="absolute inset-0 bg-[url('data:image/svg+xml;utf8, %3Csvg xmlns=\'http://www.w3.org/2000/svg\' width=\'100%25\' height=\'100%25\'%3E%3Cdefs%3E%3Cpattern id=\'grid\' width=\'40\' height=\'40\' patternUnits=\'userSpaceOnUse\'%3E%3Cpath d=\'M 40 0 L 0 0 0 40\' fill=\'none\' stroke=\'%23ffffff\' stroke-width=\'0.4\' opacity=\'0.12\'/%3E%3C/pattern%3E%3C/defs%3E%3Crect width=\'100%25\' height=\'100%25\' fill=\'url(%23grid)\'/%3E%3C/svg%3E')"] opacity-[0.07]" />
        ...
        <div className="grid md:grid-cols-12 gap-10 items-center">
          ...
          >
            <div className="aspect-[4/3] w-full rounded-2xl overflow-hidden border border-white/10 bg-[#0B0B0C] relative">
              <div className="absolute inset-0 animate-[pulsegrid_14s_ease-in-out_infinite] opacity-70" style={{ background: "radial-gradient(500px_300px_at_40%_20%,rgba(56,189,248,0.14),transparent)" }} />
              <div className="absolute inset-0" style={{ background: "radial-gradient(600px_260px_at_70%_60%,rgba(201,168,106,0.10),transparent)" }} />
              <div className="absolute inset-0 opacity-[0.08]" style={{background:"url('data:image/svg+xml;utf8, %3Csvg xmlns=\\'http://www.w3.org/2000/svg\\' width=\\'100%25\\' height=\\'100%25\\'%3E%3Cdefs%3E%3Cpattern id=\\'dot\\' width=\\'24\\' height=\\'24\\' patternUnits=\\'userSpaceOnUse\\'%3E%3Ccircle cx=\\'1\\' cy=\\'1\\' r=\\'1\\' fill=\\'%23ffffff\\' opacity=\\'0.6\\'/%3E%3C/pattern%3E%3C/defs%3E%3Crect width=\\'100%25\\' height=\\'100%25\\' fill=\\'url(%23dot)\\'/%3E%3C/svg%3E') center/auto"}} />
            </div>
          </motion.div>
